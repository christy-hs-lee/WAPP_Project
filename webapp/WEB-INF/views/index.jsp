        ...
        <div style="background-color: rgb(255, 255, 255); display: flex;-webkit-box-align: center; align-items: center;">
            <div class="header-container">
                ...
                <div class="login-container">
                    <button style="font-weight: normal;">로그인</button>
        ...
        <div class="time-sale">
            ...
            <div class="class-advertise">
                <div class="class-img-wrapper">
                    <img src="img/screencap.PNG" class="class-img" alt="Responsive image">
                </div>
    ...
    <div class="footer-container">
        <div class="footer">
            <div class="first-menu">
                <div class="logo-home">
                    <svg class="kjEHil" width="100%" height="100%" viewBox="0 0 152 32"
                        ...
                        <path d="M51.741 5.44L42.9146 26.56H48.4938L49.9755 22.7144H58.8646L60.3463 26.56H65.8947L57.0683 5.44H51.741ZM51.741 18.2385L54.4206 11.303L57.131 18.2385H51.741Z"
                              fill="#000"></path>
                        ...
                        <path d="M17.7246 21.1062C16.75 21.8927 15.5719 22.2843 14.1892 22.2843C12.5128 22.2843 11.0938 21.6826 9.9311 20.4781C8.7673 19.2736 8.1854 17.7809 8.1854 16C8.1854 14.2191 8.7673 12.7319 9.93 11.5373C11.0927 10.3438 12.5117 9.7465 14.1881 9.7465C15.5917 9.7465 16.7808 10.1282 17.7543 10.8927C18.4462 11.4361 18.9632 12.1709 19.3218 13.0773H24.78C24.2773 10.6254 23.0464 8.6674 21.0873 7.2C19.1271 5.7337 16.8281 5 14.1892 5C11.0663 5 8.4219 6.0637 6.2527 8.19C4.0835 10.3163 3 12.92 3 16C3 19.1009 4.0846 21.7101 6.2527 23.8265C8.4219 25.9407 11.0663 27 14.1892 27C16.9337 27 19.2701 26.2553 21.1973 24.7681C23.1256 23.2809 24.3301 21.2382 24.8119 18.64H19.4175C19.0325 19.6795 18.4704 20.5045 17.7246 21.1062Z"
                              fill="#000"></path>
                        <path d="M32.1808 5.44H26.98V26.56H40.7146L42.5824 22.0203H32.1808V5.44Z"
                              fill="#000"></path>
                    </svg>
                </div>
            ...
            <div class="another-menu">
                ...
                <a href="" class="another-menu-index-wrapper">
                    <div class="another-menu-index">홈</div>
                </a>
                <a href="">
                    <div class="another-menu-index">For Business</div>
                </a>
                <a href="">
                    <div class="another-menu-index">채용</div>
                </a>
            </div>
            ...
            <div class="another-menu">
                ...
                <a href="">
                    <div class="another-menu-index">크리에이터 지원하기</div>
                </a>
                <a href="">
                    <div class="another-menu-index">도움말</div>
                </a>
            </div>
            <div class="another-menu">
